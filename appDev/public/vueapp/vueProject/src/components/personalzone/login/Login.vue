          ...
          fetch(
            ...
            function (res) {
              ...
              if (flag.data.result) {
                ...
                that.$store.dispatch('updataUserInfo',res.data.useInfo);
                that.$router.go(-1);
              } else {
                that.$store.dispatch('loginFlagTrue');
...
<style lang="less" scoped>
  ...
  .nameP{
    background: url("../../../images/name.png") no-repeat 100% 100% ;
    background-size: 0.35rem 0.35rem;
  }
  .passP{
    background: url("../../../images/password.png") no-repeat 100% 100% ;
    background-size: 0.35rem 0.35rem;
  }
